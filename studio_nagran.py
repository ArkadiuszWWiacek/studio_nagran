...
def artysci_view():
    ...
    try:
        ...
        return render_template("artysci.html", artysci=artysci, sort_by=sort_by, order=order)
    finally:
        sesja.close()
...
def inzynierowie_view():
    ...
    try:
        ...
        return render_template("inzynierowie.html", inzynierowie=inzynierowie, sort_by=sort_by, order=order)
    finally:
        sesja.close()
...
def sprzet_view():
    ...
    try:
        ...
        return render_template("sprzet.html", sprzety=sprzety, sort_by=sort_by, order=order)
    finally:
        sesja.close()
...
def utwory_view():
    ...
    try:
        ...
        return render_template("utwory.html", utwory=utwory, sort_by=sort_by, order=order)
    finally:
        sesja.close()
...
def sesje_view():
    ...
    try:
        ...
        return render_template("sesje.html", sesje=sesje_list, sort_by=sort_by, order=order)
    finally:
        sesja.close()
